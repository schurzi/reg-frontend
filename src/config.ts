...
const config = checkConfig({
	...
	registrationExpirationDate: new Date('2023-09-06'),
	hoursBeforeEditAvailable: 4,
	hotelBookingLaunch: new Date('2023-01-28T12:30:23+02:00'),
	eventStartDate: new Date('2023-09-03'),
	eventEndDate: new Date('2023-09-07'),
	dayTicketStartDate: new Date('2023-09-03'),
	dayTicketEndDate: new Date('2023-09-06'),
