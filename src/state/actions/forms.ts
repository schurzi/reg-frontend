...
type ChangeFormActionBundle<F extends FormIds> = F extends FormIds ? AppActionBundle<`[Form] Change form ${F}`, DeepPartial<FormValuesType<F>>> : never
type SubmitFormActionBundle<F extends FormIds> = F extends FormIds ? AppActionBundle<`[Form] Submit form ${F}`, FormValuesType<F>> : never
