...
export const ChangeTicketType = createAction<DeepPartial<{ type: TicketType['type'] }>, '[Register] Change ticket type'>('[Register] Change ticket type')
export const ChangeTicketDay = createAction<DeepPartial<{ day: string }>, '[Register] Change ticket day'>('[Register] Change ticket day')
...
export const SubmitTicketType = createAction<{ type: TicketType['type'] }, '[Register] Submit ticket type'>('[Register] Submit ticket type')
export const SubmitTicketDay = createAction<{ day: string }, '[Register] Submit ticket day'>('[Register] Submit ticket day')
